...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    // UI references.
    private AutoCompleteTextView mEmailView, mUrlView;
    ...
    private void attemptLogin() {
        ...
        // Check if the user entered one password.
        ...
        if (cancel) {
            ...
            showProgress(true);
            mAuthTask = new UserLoginTask(this, email, password, url);
    ...
    private void showProgress(final boolean show) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB_MR2) {
            ...
            mProgressView.findViewById(R.id.progress).animate().setDuration(shortAnimTime).alpha(
     ...
     * the user.
     */
    private class UserLoginTask extends AsyncTask<Void, Void, UserResponse> {

        private Context context;
        private String email, password, url, title, message;

        public UserLoginTask(Context context, String email, String password, String url) {
        ...
        protected UserResponse doInBackground(Void... params) {
            try {
                return new UserBO().login(context, url, email, password);
            } catch (Exception e) {
